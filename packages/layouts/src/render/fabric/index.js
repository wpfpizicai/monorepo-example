...
import {CreateLinkUI, CreateNodeUI,NodeRenderer,LinkRenderer} from './ui';
import createCanvas from './createCanvas';
import eventify from '../../utils/eventify';
import wheelEvents from './domEvents';
import forceDirected from '../../forcelayout';
...
export default function (graph, settings){
  ...
  var canvas = createCanvas(settings, domContainer);
...
///////////////////////////////////////////////////////////////////////////////
  ...
  function initialize() {
    nodeUIBuilder = CreateNodeUI;
    nodeRenderer  = NodeRenderer;
    linkUIBuilder = CreateLinkUI;
  ...
  function listenToInputEvents(container) {
    var domEvents = wheelEvents(container);
  ...
  function createLayout(settings) {
    ...
    return forceDirected(graph, settings.physics);
  }
